...
class SimulationResult:
    ...
    equilibrium_prey: int    # равновесная численность жертв
    equilibrium_predator: int # равновесная численность хищников
    period: float              # период колебаний
    stability_type: str        # тип устойчивости
    avg_prey: int            # средняя численность жертв #к целому
    avg_predator: int        # средняя численность хищников
